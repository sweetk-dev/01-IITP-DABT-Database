...
CREATE INDEX idx_open_api_client_cli_name ON public.open_api_client USING btree (client_name);
...
COMMENT ON COLUMN public.open_api_client.created_by IS '데이터 생성자 (SYS-BACH, SYS-MANUAL, user id), "sys_work_type" comm code 참조';
COMMENT ON COLUMN public.open_api_client.updated_by IS '데이터 수정자';
COMMENT ON COLUMN public.open_api_client.deleted_by IS '데이터 삭제자';
...
COMMENT ON COLUMN public.open_api_client_key.active_yn IS '활성화 여부 (Y:활성화)';
COMMENT ON COLUMN public.open_api_client_key.del_yn IS '삭제여부 (Y: 삭제)';
...
COMMENT ON COLUMN public.open_api_client_key.created_by IS '데이터 생성자 (SYS-BACH, SYS-MANUAL, user id), "sys_work_type" comm code 참조';
COMMENT ON COLUMN public.open_api_client_key.updated_by IS '데이터 수정자';
COMMENT ON COLUMN public.open_api_client_key.deleted_by IS '데이터 삭제자';
...
COMMENT ON COLUMN public.sys_stats_src_api_info.created_by IS '데이터 생성자 (SYS-BACH, SYS-MANUAL, user id), "sys_work_type" comm code 참조';
