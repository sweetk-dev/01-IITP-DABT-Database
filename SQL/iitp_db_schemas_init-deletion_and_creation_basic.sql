...
-- ## ver 0.0.3 last update data : 2025.05.21
-- ## Only for PostgreSQL
-- ## Except "mv_poi" table
...
CREATE TABLE public.sys_common_code (
	...
	updated_at timestamptz DEFAULT CURRENT_TIMESTAMP NOT NULL, -- 수정 시각 (UTC)
...
CREATE TABLE public.sys_ext_api_info (
	...
	auth varchar(200) NULL, -- 내부 키로 암호화된 인증키 
...
COMMENT ON COLUMN public.stats_src_data_info.stat_pub_dt IS '작성시점';
...
COMMENT ON TABLE public.stats_kosis_origin_data IS 'KOSIS 원천 통계 데이터';
...
COMMENT ON COLUMN public.stats_kosis_origin_data.c1 IS '분류값 ID1, 값>3자일 일경우 앞3자리로 group id를 찾아 표시해야함. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_kosis_origin_data.c2 IS '분류값 ID2, 값>3자일 일경우 앞3자리로 group id를 찾아 표시해야함. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_kosis_origin_data.c3 IS '분류값 ID3, 값>3자일 일경우 앞3자리로 group id를 찾아 표시해야함. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_kosis_origin_data.c4 IS '분류값 ID4, 값>3자일 일경우 앞3자리로 group id를 찾아 표시해야함. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
...
COMMENT ON COLUMN public.stats_kosis_origin_data.itm_id IS '항목 ID';
COMMENT ON COLUMN public.stats_kosis_origin_data.itm_nm IS '항목명';
...
COMMENT ON COLUMN public.stats_dis_reg_natl_by_new.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_natl_by_new.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_natl_by_new.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_reg_natl_by_new.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_reg_natl_by_age_type_sev_gen.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_natl_by_age_type_sev_gen.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_natl_by_age_type_sev_gen.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_reg_natl_by_age_type_sev_gen.itm_id IS '항목 ID';
...
CREATE TABLE public.stats_dis_reg_sido_by_age_type_sev_gen (
	...
	CONSTRAINT pkey_st_dis_reg_sido_by_age_type_sev_gen PRIMARY KEY (id)
);
CREATE INDEX idx_st_dis_reg_sido_by_age_type_sev_gen_year_c1t3 ON public.stats_dis_reg_sido_by_age_type_sev_gen USING btree (prd_de, c1, c2, c3);
...
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.prd_de IS '수록시점, 연도 (예: 2024)';

COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';


COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.itm_id IS '항목 ID';

COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.unit_nm IS '단위명';

COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.prd_de IS '수록시점';

COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.dt IS '수치 값';

COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.lst_chn_de IS ' 데이터별 최종 수정일';
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.src_latest_chn_dt IS ' 수집기관 최종 자료갱신일';
...
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.created_by IS '데이터 생성자 (SYS-BACH, SYS-MANUAL, user id), "sys_work_type" comm code 참조';
COMMENT ON COLUMN public.stats_dis_reg_sido_by_age_type_sev_gen.updated_by IS '데이터 수정자';


-- public.stats_dis_reg_sido_by_age_type_sev_gen foreign keys

ALTER TABLE public.stats_dis_reg_sido_by_age_type_sev_gen ADD CONSTRAINT fk_st_dis_reg_sido_by_age_type_sev_gen FOREIGN KEY (src_data_id) REFERENCES public.stats_src_data_info(src_data_id);
...
COMMENT ON COLUMN public.stats_dis_life_supp_need_lvl.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_supp_need_lvl.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_supp_need_lvl.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_life_supp_need_lvl.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_life_maincarer.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_maincarer.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_maincarer.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_life_maincarer.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_life_primcarer.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_primcarer.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_primcarer.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_life_primcarer.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_life_supp_field.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_supp_field.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_life_supp_field.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_life_supp_field.itm_id IS '항목 ID';
...
CREATE TABLE public.stats_dis_hlth_medical_usage (
	...
	c1 VARCHAR(24) NOT NULL, c2 VARCHAR(24), c3 VARCHAR(24), -- 분류값 ID1 ~ 3, 값>3자이고 첫문자가 문자인 경우: 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류
...
COMMENT ON COLUMN public.stats_dis_emp_natl.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_emp_natl_public.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_public.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_public.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl_public.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_emp_natl_private.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_private.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_private.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl_private.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_emp_natl_gov_org.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_gov_org.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_gov_org.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl_gov_org.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_sev.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_sev.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_sev.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_sev.itm_id IS '항목 ID';
...
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_indust.c1 IS '분류값 ID1, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_indust.c2 IS '분류값 ID2, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';
COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_indust.c3 IS '분류값 ID3, 값>3자이고 첫문자가 문자인 경우 앞3자리는  group id, 검색 후 group id nm으 로표시. c#_obj하위에 group임. c#_obj > c# group > c#, itm_id는 별도 분류';

COMMENT ON COLUMN public.stats_dis_emp_natl_dis_type_indust.itm_id IS '항목 ID';
