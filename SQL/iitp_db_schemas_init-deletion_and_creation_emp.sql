...
-- ## ver 0.0.4 last update data : 2025.07.11
-- ## Only for PostgreSQL
...
CREATE INDEX idx_emp_dis_center_usage_org_category ON public.emp_dis_center_usage (org_category);
...
COMMENT ON COLUMN public.emp_dis_center_usage.org_category IS '훈련기관구분';
