...
-- ============================================================================
-- 긴급대응 지원시설 (v1.6.0) — 보장구 수리·충전·콜택시
-- 전동 보장구 이용자의 이동 중 고장·방전 대응 자원. 운영시간을 별도 컬럼으로 두는
-- 이유는 수리센터가 주간에만 운영해 야간에는 위치만으로는 쓸모가 없기 때문이다.
-- ============================================================================
CREATE TABLE public.poi_emergency_support (
